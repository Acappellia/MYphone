...
execute positioned ~ ~1.6 ~ run data modify entity @e[type=interaction,tag=plg_menu,distance=..0.2,limit=1] Rotation set from entity @s Rotation

playsound ui.toast.in block @s ~ ~ ~ 1 1.2

execute positioned ~ ~1.61 ~ as @e[type=interaction,tag=plg_menu,distance=..0.2] at @s run function plg:testmenu/menus/home