data merge entity @s {Tags:["mp_wechat_af_receive","mp_wechat_af","mp_wechat","mp_app_element","mp_static","mp_display"],transformation:[-20,0,0,0,0,20,0,0,0,0,-20,-3,0,0,0,250],alignment:"left",billboard:"fixed",view_range:0.01f,background:0}
