execute as @e[distance=..2,tag=menu_icon,type=item_display] at @s run function plg:testmenu/icons/clear_highlight
...
schedule function plg:testmenu/animation/schedule_menu1 2t replace