...
execute positioned ^ ^ ^0.5 as @e[distance=..1,limit=1,tag=mp_wgroup_intext,type=text_display] run function mp:phone/animation/update_ginput with storage mp:tmp p_info
