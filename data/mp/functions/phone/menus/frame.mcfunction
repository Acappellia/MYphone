...
execute if score #time_hour mp matches 6..17 summon text_display run function mp:phone/summon/signal
execute unless score #time_hour mp matches 6..17 summon text_display run function mp:phone/summon/signal_night
