...
execute at @s unless entity @e[type=text_display,tag=highlight,distance=..0.2] run function mp:phone/icons/summon_highlight

tag @s add seleted
execute as @e[distance=..2,tag=menu_icon,type=item_display,tag=!seleted] at @s run function mp:phone/icons/clear_highlight
