data merge entity @s {Tags:["mp_wechat_friend","mp_wechat","mp_app_element","mp_static","mp_display"],transformation:[-35,0,0,0,0,35,0,0,0,0,-35,-4,0,0,0,250],alignment:"left",billboard:"fixed",view_range:0.01f,glow_color_override:5066061,background:0}
