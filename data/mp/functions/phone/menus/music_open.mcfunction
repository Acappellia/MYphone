...
execute unless score @s p_music_sl_0 matches 1.. positioned ^ ^0.02 ^ summon text_display run function mp:phone/summon/music/0/add
execute if score @s p_music_sl_0 matches 1.. positioned ^ ^0.02 ^ summon text_display run function mp:phone/summon/music/0/remove
...
execute if score @s p_music_sl_1 matches 1 positioned ^ ^-0.06 ^ summon text_display run function mp:phone/summon/music/1/remove
...
execute if score @s p_music_sl_2 matches 1 positioned ^ ^-0.13 ^ summon text_display run function mp:phone/summon/music/2/remove
...
execute if score @s p_music_sl_3 matches 1 positioned ^ ^-0.20 ^ summon text_display run function mp:phone/summon/music/3/remove
...
execute if score @s p_music_sl_4 matches 1 positioned ^ ^-0.27 ^ summon text_display run function mp:phone/summon/music/4/remove
...
execute if score @s p_music_sl_5 matches 1 positioned ^ ^-0.34 ^ summon text_display run function mp:phone/summon/music/5/remove
...
execute if score @s p_music_sl_6 matches 1 positioned ^ ^-0.41 ^ summon text_display run function mp:phone/summon/music/6/remove
...
execute unless score @s p_music_playing matches 1.. summon text_display run function mp:phone/summon/music/musicplay
execute if score @s p_music_playing matches 1.. summon text_display run function mp:phone/summon/music/musicstop