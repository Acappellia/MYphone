...
function mp:phone/menus/wechat/friend with storage mp:tmp p_info
execute store result storage mp:tmp p_info.friend_index int 1 run scoreboard players add #friend_index_init mp 1
execute positioned ^ ^-0.1 ^ run function mp:phone/menus/wechat/friend with storage mp:tmp p_info
execute store result storage mp:tmp p_info.friend_index int 1 run scoreboard players add #friend_index_init mp 1
execute positioned ^ ^-0.2 ^ run function mp:phone/menus/wechat/friend with storage mp:tmp p_info
execute store result storage mp:tmp p_info.friend_index int 1 run scoreboard players add #friend_index_init mp 1
execute positioned ^ ^-0.3 ^ run function mp:phone/menus/wechat/friend with storage mp:tmp p_info