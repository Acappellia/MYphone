...
execute at @s unless entity @e[type=text_display,tag=highlight,distance=..0.2] run function plg:testmenu/icons/summon_highlight

tag @s add seleted
execute as @e[distance=..2,tag=menu_icon,type=item_display,tag=!seleted] at @s run function plg:testmenu/icons/clear_highlight
