...
execute as @a[distance=..10,scores={p_active_app=103}] at @s anchored eyes positioned ^ ^ ^ at @e[distance=..0.1,sort=nearest,type=interaction,tag=mp_menu] run function mp:phone/clicks/wechat/af_receivefriends with storage mp:tmp p_info
