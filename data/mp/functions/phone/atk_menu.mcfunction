...
advancement revoke @s only mp:atk_menu
...
execute as @e[distance=..5,type=interaction,tag=mp_menu] store result score @s m_interact_time run data get entity @s attack.timestamp
