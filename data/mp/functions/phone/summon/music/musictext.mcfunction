data merge entity @s {text:'[{"text":"                                          \\n"},{"text": "未播放歌曲","color": "white"}]',Tags:["mp_music_info","mp_music","mp_app_element","mp_static","mp_display"],transformation:[-20,0,0,0,0,20,0,0,0,0,-20,-3,0,0,0,250],alignment:"left",billboard:"fixed",view_range:0.01f,background:0}
