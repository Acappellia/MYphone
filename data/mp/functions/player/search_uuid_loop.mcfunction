...
execute store success score #search_uuid_check lc_var run data modify storage mp:tmp search.check_UUID set from storage mp:tmp search.target_UUID
...
execute store success score #search_uuid_check lc_var run data modify storage mp:tmp search.check_UUID set from storage mp:tmp search.init_UUID
data modify storage mp:tmp search.check_UUID set from storage mp:player uuid_check[0].UUID
